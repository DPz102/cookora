...
mixin _$PostEntity {
 ...
 String? get id; String get imageUrl; String get caption; String get authorId; String get authorUsername; String get authorAvatarUrl; List<String> get likes; int get commentCount; int get bookmarkCount;@JsonKey(fromJson: _timestampToDateTime, toJson: _dateTimeToTimestamp) DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,imageUrl,caption,authorId,authorUsername,authorAvatarUrl,const DeepCollectionEquality().hash(likes),commentCount,bookmarkCount,createdAt);

@override
String toString() {
  return 'PostEntity(id: $id, imageUrl: $imageUrl, caption: $caption, authorId: $authorId, authorUsername: $authorUsername, authorAvatarUrl: $authorAvatarUrl, likes: $likes, commentCount: $commentCount, bookmarkCount: $bookmarkCount, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String? id, String imageUrl, String caption, String authorId, String authorUsername, String authorAvatarUrl, List<String> likes, int commentCount, int bookmarkCount,@JsonKey(fromJson: _timestampToDateTime, toJson: _dateTimeToTimestamp) DateTime? createdAt
});
...
/// Create a copy of PostEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? imageUrl = null,Object? caption = null,Object? authorId = null,Object? authorUsername = null,Object? authorAvatarUrl = null,Object? likes = null,Object? commentCount = null,Object? bookmarkCount = null,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String imageUrl,  String caption,  String authorId,  String authorUsername,  String authorAvatarUrl,  List<String> likes,  int commentCount,  int bookmarkCount, @JsonKey(fromJson: _timestampToDateTime, toJson: _dateTimeToTimestamp)  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostEntity() when $default != null:
return $default(_that.id,_that.imageUrl,_that.caption,_that.authorId,_that.authorUsername,_that.authorAvatarUrl,_that.likes,_that.commentCount,_that.bookmarkCount,_that.createdAt);case _:
  return orElse();
...
class _PostEntity implements PostEntity {
  const _PostEntity({this.id, required this.imageUrl, required this.caption, required this.authorId, this.authorUsername = '', this.authorAvatarUrl = '', required final  List<String> likes, this.commentCount = 0, this.bookmarkCount = 0, @JsonKey(fromJson: _timestampToDateTime, toJson: _dateTimeToTimestamp) this.createdAt}): _likes = likes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,imageUrl,caption,authorId,authorUsername,authorAvatarUrl,const DeepCollectionEquality().hash(_likes),commentCount,bookmarkCount,createdAt);
...
/// Create a copy of PostEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? imageUrl = null,Object? caption = null,Object? authorId = null,Object? authorUsername = null,Object? authorAvatarUrl = null,Object? likes = null,Object? commentCount = null,Object? bookmarkCount = null,Object? createdAt = freezed,}) {
