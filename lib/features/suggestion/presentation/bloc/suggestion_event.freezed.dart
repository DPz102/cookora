...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( SubscribeToSuggestions value)?  subscribeToSuggestions,TResult Function( SuggestionsReceived value)?  suggestionsReceived,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return suggestionsReceived(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( SubscribeToSuggestions value)  subscribeToSuggestions,required TResult Function( SuggestionsReceived value)  suggestionsReceived,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( SubscribeToSuggestions value)?  subscribeToSuggestions,TResult? Function( SuggestionsReceived value)?  suggestionsReceived,}){
final _that = this;
switch (_that) {
case SubscribeToSuggestions() when subscribeToSuggestions != null:
return subscribeToSuggestions(_that);case SuggestionsReceived() when suggestionsReceived != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String uid)?  subscribeToSuggestions,TResult Function( List<RecipeEntity> recipes)?  suggestionsReceived,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SubscribeToSuggestions() when subscribeToSuggestions != null:
return subscribeToSuggestions(_that.uid);case SuggestionsReceived() when suggestionsReceived != null:
return suggestionsReceived(_that.recipes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String uid)  subscribeToSuggestions,required TResult Function( List<RecipeEntity> recipes)  suggestionsReceived,}) {final _that = this;
switch (_that) {
case SubscribeToSuggestions():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String uid)?  subscribeToSuggestions,TResult? Function( List<RecipeEntity> recipes)?  suggestionsReceived,}) {final _that = this;
switch (_that) {
case SubscribeToSuggestions() when subscribeToSuggestions != null:
return subscribeToSuggestions(_that.uid);case SuggestionsReceived() when suggestionsReceived != null:
return suggestionsReceived(_that.recipes);case _:
