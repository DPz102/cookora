...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( SubscribeToKitchenLog value)?  subscribeToKitchenLog,TResult Function( AddRecipeToLog value)?  addRecipeToLog,TResult Function( KitchenLogUpdated value)?  kitchenLogUpdated,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return kitchenLogUpdated(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( SubscribeToKitchenLog value)  subscribeToKitchenLog,required TResult Function( AddRecipeToLog value)  addRecipeToLog,required TResult Function( KitchenLogUpdated value)  kitchenLogUpdated,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( SubscribeToKitchenLog value)?  subscribeToKitchenLog,TResult? Function( AddRecipeToLog value)?  addRecipeToLog,TResult? Function( KitchenLogUpdated value)?  kitchenLogUpdated,}){
final _that = this;
switch (_that) {
case SubscribeToKitchenLog() when subscribeToKitchenLog != null:
return subscribeToKitchenLog(_that);case AddRecipeToLog() when addRecipeToLog != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String uid)?  subscribeToKitchenLog,TResult Function( RecipeEntity recipe)?  addRecipeToLog,TResult Function( List<RecipeEntity> recipes)?  kitchenLogUpdated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SubscribeToKitchenLog() when subscribeToKitchenLog != null:
...
return kitchenLogUpdated(_that.recipes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String uid)  subscribeToKitchenLog,required TResult Function( RecipeEntity recipe)  addRecipeToLog,required TResult Function( List<RecipeEntity> recipes)  kitchenLogUpdated,}) {final _that = this;
switch (_that) {
case SubscribeToKitchenLog():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String uid)?  subscribeToKitchenLog,TResult? Function( RecipeEntity recipe)?  addRecipeToLog,TResult? Function( List<RecipeEntity> recipes)?  kitchenLogUpdated,}) {final _that = this;
switch (_that) {
case SubscribeToKitchenLog() when subscribeToKitchenLog != null:
return subscribeToKitchenLog(_that.uid);case AddRecipeToLog() when addRecipeToLog != null:
return addRecipeToLog(_that.recipe);case KitchenLogUpdated() when kitchenLogUpdated != null:
