  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AuthBloc, AuthState>(
      listener: (context, state) {
        ...
        if (state.authRequestState is AsyncFailure) {
          final error = (state.authRequestState as AsyncFailure).error;
      ...
      builder: (context, state) {
        ...
        final isLoading = state.authRequestState is AsyncLoading;
