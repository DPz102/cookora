...
class AsyncFailure<T> implements AsyncState<T> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AsyncFailure<T>&&(identical(other.error, error) || other.error == error));
}
